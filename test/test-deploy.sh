...
docker tag nodeshift/ubi8-s2i-nodejs:12.x 172.30.1.1:5000/nodeshift/ubi8-s2i-nodejs:12.x

# Pushes the image to the openshift docker registry.
docker push 172.30.1.1:5000/nodeshift/ubi8-s2i-nodejs:12.x

# Creates a new app based on the pushed image.
oc new-app 172.30.1.1:5000/nodeshift/ubi8-s2i-nodejs:12.x~https://github.com/nodeshift/nodejs-rest-http
